...
public class nahidInfo extends JFrame implements ActionListener {
...
//        img.setBorder(Color.MAGENTA,);
        ...
        JLabel blood=new JLabel("Blood Group: B+");
